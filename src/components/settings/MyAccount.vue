<template>
  <div class="p-6 space-y-6 grow">
    ...
    <section>
      <h3 class="text-xl leading-snug text-slate-800 font-bold mb-1">Public profile</h3>
    ...
    <section>
      <h3 class="text-xl leading-snug text-slate-800 font-bold mb-1">Account details</h3>
      <div class="sm:flex sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-5">
        <div class="sm:w-1/3">
